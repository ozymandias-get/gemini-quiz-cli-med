              ...
              {!pdfText ? (
                ...
                <div className="flex-1 flex flex-col items-center justify-center text-center py-6">
                   ...
                   <label className="cursor-pointer flex-1 sm:flex-none">
                      <input type="file" accept=".pdf" onChange={onUpload} className="hidden" />
                      <span className="text-xs font-bold text-stone-500 uppercase tracking-widest flex items-center justify-center gap-2 px-6 py-3 bg-stone-100 dark:bg-stone-800 rounded-xl">
